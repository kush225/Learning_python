...
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1">#Regular Expression(RE)</span>
<span class="c1">#A regular expression is a special sequence of characters that helps you match or find other strings or sets of strings, using a specialized syntax held in a pattern</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1">#rawstring</span>
<span class="c1"># Python raw string is created by prefixing a string literal with &#39;r&#39; or &#39;R&#39;. Python raw string treats backslash (\) as a literal character. This is useful when we want to have a string that contains backslash and don&#39;t want it to be treated as an escape character.</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;</span><span class="se">\t</span><span class="s2">Tab&quot;</span><span class="p">)</span>  <span class="c1">#simple string</span>
<span class="nb">print</span><span class="p">(</span><span class="sa">r</span><span class="s2">&quot;\tTab&quot;</span><span class="p">)</span> <span class="c1">#raw_string</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1">#re.compile Compile a regular expression pattern into a regular expression object, which can be used for matching using its match() and search() method</span>
...
<span class="n">matches</span> <span class="o">=</span> <span class="n">pattern</span><span class="o">.</span><span class="n">finditer</span><span class="p">(</span><span class="n">text_to_search</span><span class="p">)</span>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>&lt;re.Match object; span=(1, 4), match=&#39;abc&#39;&gt;
</pre>
</div>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1">#if we wanna search for a Metacharacter like a period &quot;.&quot; we need to use a escape character (\) </span>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>&lt;re.Match object; span=(111, 112), match=&#39;.&#39;&gt;
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># #MetaCharacters</span>

<span class="c1"># .       - Any Character Except New Line</span>
<span class="c1"># \d      - Digit (0-9)</span>
<span class="c1"># \D      - Not a Digit (0-9)</span>
<span class="c1"># \w      - Word Character (a-z, A-Z, 0-9, _)</span>
<span class="c1"># \W      - Not a Word Character</span>
<span class="c1"># \s      - Whitespace (space, tab, newline)</span>
<span class="c1"># \S      - Not Whitespace (space, tab, newline)</span>

<span class="c1"># \b      - Word Boundary</span>
<span class="c1"># \B      - Not a Word Boundary</span>
<span class="c1"># ^       - Beginning of a String</span>
<span class="c1"># $       - End of a String</span>

<span class="c1"># []      - Matches Characters in brackets</span>
<span class="c1"># [^ ]    - Matches Characters NOT in brackets</span>
<span class="c1"># |       - Either Or</span>
...
<span class="c1"># {3}     - Exact Number</span>
<span class="c1"># {3,4}   - Range of Numbers (Minimum, Maximum)</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">pattern</span> <span class="o">=</span> <span class="n">re</span><span class="o">.</span><span class="n">compile</span><span class="p">(</span><span class="sa">r</span><span class="s1">&#39;\d</span><span class="si">{3}</span><span class="s1">.\d</span><span class="si">{3}</span><span class="s1">.\d</span><span class="si">{3}</span><span class="s1">&#39;</span><span class="p">)</span>
<span class="n">matches</span> <span class="o">=</span> <span class="n">pattern</span><span class="o">.</span><span class="n">finditer</span><span class="p">(</span><span class="n">text_to_search</span><span class="p">)</span>
<span class="k">for</span> <span class="n">match</span> <span class="ow">in</span> <span class="n">matches</span><span class="p">:</span>
    <span class="nb">print</span><span class="p">(</span><span class="n">match</span><span class="p">)</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>&lt;re.Match object; span=(151, 162), match=&#39;321-555-432&#39;&gt;
...
<span class="s1">http://coreyms.com</span>
<span class="s1">https://youtube.com</span>
<span class="s1">https://www.nasa.gov</span>
<span class="s1">&#39;&#39;&#39;</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1">#matching using groups</span>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>&lt;re.Match object; span=(1, 23), match=&#39;https://www.google.com&#39;&gt;
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1">#matching domaing name and top level domain eg. facebook.com</span>
<span class="c1">#in this case group 0 is whole match, group 1 is www. group2 is domain name and group 3 is toplevel domain</span>
<span class="n">pattern</span> <span class="o">=</span> <span class="n">re</span><span class="o">.</span><span class="n">compile</span><span class="p">(</span><span class="sa">r</span><span class="s1">&#39;https?://(www\.)?(\w+)(\.\w+)&#39;</span><span class="p">)</span>
<span class="n">matches</span><span class="o">=</span> <span class="n">pattern</span><span class="o">.</span><span class="n">finditer</span><span class="p">(</span><span class="n">urls</span><span class="p">)</span>

<span class="c1">#accessing group2 domain name and group 3 tom level domain</span>
<span class="k">for</span> <span class="n">match</span> <span class="ow">in</span> <span class="n">matches</span><span class="p">:</span>
    <span class="nb">print</span><span class="p">(</span><span class="n">match</span><span class="o">.</span><span class="n">group</span><span class="p">(</span><span class="mi">2</span><span class="p">)</span><span class="o">+</span><span class="n">match</span><span class="o">.</span><span class="n">group</span><span class="p">(</span><span class="mi">3</span><span class="p">))</span>
</pre></div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1">#substituting using regex</span>

<span class="n">pattern</span> <span class="o">=</span> <span class="n">re</span><span class="o">.</span><span class="n">compile</span><span class="p">(</span><span class="sa">r</span><span class="s1">&#39;https?://(www\.)?(\w+)(\.\w+)&#39;</span><span class="p">)</span>

<span class="c1">#subsituting group2 and 3 with whole url</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">pattern</span> <span class="o">=</span> <span class="n">re</span><span class="o">.</span><span class="n">compile</span><span class="p">(</span><span class="sa">r</span><span class="s1">&#39;https?://(www\.)?(\w+)(\.\w+)&#39;</span><span class="p">)</span>
<span class="n">matches</span><span class="o">=</span> <span class="n">pattern</span><span class="o">.</span><span class="n">findall</span><span class="p">(</span><span class="n">urls</span><span class="p">)</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1">#match matches only one pattern and should be at begining of line</span>
<span class="n">sentence</span> <span class="o">=</span> <span class="s1">&#39;Start a sentence and then bring it to an end&#39;</span>

<span class="n">pattern</span> <span class="o">=</span> <span class="n">re</span><span class="o">.</span><span class="n">compile</span><span class="p">(</span><span class="sa">r</span><span class="s1">&#39;Start&#39;</span><span class="p">)</span>

<span class="n">matches</span> <span class="o">=</span> <span class="n">pattern</span><span class="o">.</span><span class="n">match</span><span class="p">(</span><span class="n">sentence</span><span class="p">)</span>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>&lt;re.Match object; span=(0, 5), match=&#39;Start&#39;&gt;
</pre>
</div>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1">#search the entire file and returns the first match</span>
<span class="n">sentence</span> <span class="o">=</span> <span class="s1">&#39;Start a sentence and then bring it to an end&#39;</span>

<span class="n">pattern</span> <span class="o">=</span> <span class="n">re</span><span class="o">.</span><span class="n">compile</span><span class="p">(</span><span class="sa">r</span><span class="s1">&#39;start&#39;</span><span class="p">,</span> <span class="n">re</span><span class="o">.</span><span class="n">I</span><span class="p">)</span> 
<span class="c1">#re.I or re.IGNORECASE is a flag for case insensitive </span>

<span class="n">matches</span> <span class="o">=</span> <span class="n">pattern</span><span class="o">.</span><span class="n">search</span><span class="p">(</span><span class="n">sentence</span><span class="p">)</span>
